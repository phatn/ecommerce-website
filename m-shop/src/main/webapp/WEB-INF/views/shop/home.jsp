...
<div class="container">
    <p class="text-muted lead text-center">NEW ARRIVALS</p>
    ...
    <div class="row products">
            ...
            <div class="product">
                <div class="image">
                    <a href="shop-detail.html">
                        <img src="<c:url value='/resources/img/product1.jpg'/> " alt="" class="img-responsive image1">
                    </a>
                </div>
                <!-- /.image -->
                <div class="text">
        ...
        <div class="col-md-3 col-sm-4">
            <div class="product">
                <div class="image">
                    <a href="shop-detail.html">
                        <img src="<c:url value='/resources/img/product2.jpg'/> " alt="" class="img-responsive image1">
                    </a>
                </div>
                <!-- /.image -->
                <div class="text">
        ...
        <div class="col-md-3 col-sm-4">
            <div class="product">
                <div class="image">
                    <a href="shop-detail.html">
                        <img src="<c:url value='/resources/img/product3.jpg'/> " alt="" class="img-responsive image1">
                    </a>
                </div>
                <!-- /.image -->
                <div class="text">
        ...
        <div class="col-md-3 col-sm-4">
            <div class="product">
                <div class="image">
                    <a href="shop-detail.html">
                        <img src="<c:url value='/resources/img/product4.jpg'/> " alt="" class="img-responsive image1">
                    </a>
                </div>
                <!-- /.image -->
                <div class="text">
